...
All test for the base_model.py are implemented here.
"""
...
class TestBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.my_model.name = "Bonita Rai"

    def TearDown(self):
        """
            Removes/tears down instance.
        """
        del self.my_model
    ...
    #     """
    #     self.assertEqual("Bonita Rai", self.my_model.name)
    ...
    def test_save(self):
        """
            Checks after updating the instance; the dates differs in the
    ...
    def test_to_dict_type_created_at(self):
        """
            Checks type of the value of created_at.
        """
